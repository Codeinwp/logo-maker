import { a as commonjsGlobal, c as createCommonjsModule, g as getDefaultExportFromCjs } from './common/_commonjsHelpers-8c19dec8.js';
...
var reactCSS = /*@__PURE__*/getDefaultExportFromCjs(lib);
...
var Checkboard = function Checkboard(_ref) {
  ...
  return react.isValidElement(children) ? react.cloneElement(children, _extends({}, children.props, { style: _extends({}, children.props.style, styles.grid) })) : react.createElement('div', { style: styles.grid });
};
  ...
  _createClass(Alpha, [{
    ...
    value: function render() {
      ...
      var styles = reactCSS({
        ...
        'overwrite': _extends$1({}, this.props.style)
      }, {
...
var EditableInput = function (_ref) {
  _inherits$1(EditableInput, _ref);

  function EditableInput(props) {
    _classCallCheck$1(this, EditableInput);

    var _this = _possibleConstructorReturn$1(this, (EditableInput.__proto__ || Object.getPrototypeOf(EditableInput)).call(this));
...
var Hue = function (_ref) {
  ...
  function Hue() {
    ...
    _classCallCheck$2(this, Hue);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$2(this, (_ref2 = Hue.__proto__ || Object.getPrototypeOf(Hue)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function (e) {
...
function assignValue$1(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$j.call(object, key) && eq$1(objValue, value)) ||
      (value === undefined && !(key in object))) {
    baseAssignValue$1(object, key, value);
  }
}
...
var calculateChange$2 = function calculateChange(e, hsl, container) {
...
var Saturation = function (_ref) {
  _inherits$3(Saturation, _ref);

  function Saturation(props) {
    _classCallCheck$3(this, Saturation);

    var _this = _possibleConstructorReturn$3(this, (Saturation.__proto__ || Object.getPrototypeOf(Saturation)).call(this, props));

    _this.handleChange = function (e) {
      typeof _this.props.onChange === 'function' && _this.throttle(_this.props.onChange, calculateChange$2(e, _this.props.hsl, _this.container), e);
    };
...
var ColorWrap = function ColorWrap(Picker) {
  var ColorPicker = function (_ref) {
    _inherits$4(ColorPicker, _ref);

    function ColorPicker(props) {
      _classCallCheck$4(this, ColorPicker);

      var _this = _possibleConstructorReturn$4(this, (ColorPicker.__proto__ || Object.getPrototypeOf(ColorPicker)).call(this));
      ...
      _this.state = _extends$2({}, toState(props.color, 0));
    ...
    _createClass$4(ColorPicker, [{
      ...
      value: function render() {
        ...
        return react.createElement(Picker, _extends$2({}, this.props, this.state, {
          onChange: this.handleChange
        }, optionalEvents));
      }
    }], [{
      ...
      value: function getDerivedStateFromProps(nextProps, state) {
        return _extends$2({}, toState(nextProps.color, state.oldHue));
      }
    }]);
    ...
    _createClass$5(Focus, [{
      ...
      value: function render() {
        return react.createElement(
          ...
          react.createElement(Component, _extends$3({}, this.props, this.state))
        );
      }
    }]);
...
function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  objTag = objTag == argsTag$6 ? objectTag$8 : objTag;
  othTag = othTag == argsTag$6 ? objectTag$8 : othTag;
...
var CircleSwatch$1 = lib.handleHover(CircleSwatch);
...
var UnfoldMoreHorizontalIcon$1 = /*@__PURE__*/getDefaultExportFromCjs(UnfoldMoreHorizontalIcon);
...
var ChromeFields = function (_React$Component) {
  _inherits$6(ChromeFields, _React$Component);

  function ChromeFields(props) {
    _classCallCheck$6(this, ChromeFields);

    var _this = _possibleConstructorReturn$6(this, (ChromeFields.__proto__ || Object.getPrototypeOf(ChromeFields)).call(this));
...
var GithubSwatch$1 = lib.handleHover(GithubSwatch);
...
var HuePicker = function HuePicker(_ref) {
  ...
  return react.createElement(
    ...
    react.createElement(Hue, _extends$6({}, styles.hue, {
      hsl: hsl,
      pointer: pointer,
      onChange: handleChange,
      direction: direction
...
var Photoshop = function (_React$Component) {
  _inherits$7(Photoshop, _React$Component);

  function Photoshop(props) {
    _classCallCheck$7(this, Photoshop);

    var _this = _possibleConstructorReturn$7(this, (Photoshop.__proto__ || Object.getPrototypeOf(Photoshop)).call(this));
  ...
  return react.createElement(
    ...
    colors.map(function (colorObjOrString) {
      ...
      return react.createElement(
        ...
        react.createElement(Swatch$1, _extends$7({}, c, {
          style: styles.swatch,
          onClick: handleClick,
          onHover: onSwatchHover,
          focusStyle: {
...
var CheckIcon$1 = /*@__PURE__*/getDefaultExportFromCjs(CheckIcon);
...
export { Slider$1 as SliderPicker };

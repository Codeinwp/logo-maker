...
export function buildText(parent: Svg, props: TTitle | TSlogan, type: 'svg' | 'text' | 'auto', fontRenderes?: FontRenderers): Svg | Text {
    switch(type) {
        case 'svg':
        ...
        case 'auto':
            return isFontFromGoogle(props.style.fontFamily) && fontRenderes ? buildText(parent, props, 'svg', fontRenderes) : buildText(parent, props, 'text')
    }
}
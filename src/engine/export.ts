...
export function exportImagesfromCANVAS(canvas: HTMLCanvasElement, format: "png" | "jpg" | "webp" ): string {
...
export async function exportAsZipFromSVGviaLink(svg: SVGElement, formats: ("png" | "jpg" | "webp") [], includeSVG?: boolean): Promise<string> {
        // Create images
